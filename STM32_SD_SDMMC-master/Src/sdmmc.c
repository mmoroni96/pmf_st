...
void MX_SDMMC1_SD_Init(void)
{
  ...
  hsd1.Init.HardwareFlowControl = SDMMC_HARDWARE_FLOW_CONTROL_DISABLE; // SDMMC_HARDWARE_FLOW_CONTROL_ENABLE, SDMMC_HARDWARE_FLOW_CONTROL_DISABLE
...
void HAL_SD_MspInit(SD_HandleTypeDef* sdHandle)
{
  ...
  /* USER CODE END SDMMC1_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;  // GPIO_SPEED_FREQ_HIGH, GPIO_SPEED_FREQ_VERY_HIGH
