...
/**
  ...
  */
#define NUCLEO_SPI                                     SPI2
#define NUCLEO_SPI_CLK_ENABLE()                        __HAL_RCC_SPI2_CLK_ENABLE()

#define NUCLEO_SPI_SCK_AF                              GPIO_AF5_SPI2
...
#define NUCLEO_SPI_MISO_AF                             GPIO_AF5_SPI2
...
#define NUCLEO_SPI_MOSI_AF                             GPIO_AF5_SPI2
...
#if (USE_HAL_SPI_REGISTER_CALLBACKS == 1)
int32_t BSP_SPI2_RegisterMspCallbacks(BSP_SPI1_Cb_t *CallBacks);
...
HAL_StatusTypeDef MX_BSP_SPI2_Init(SPI_HandleTypeDef *hspi);
